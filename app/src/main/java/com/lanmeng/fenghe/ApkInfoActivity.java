...
public class ApkInfoActivity extends BaseActivity {
    ...
    private static final String SECURITY_PKG = "com.lanmeng.security";
    private static final String LAUNCHER_PKG = "com.lanmeng.launcher";
...
//                getSigByPkgName("com.lanmeng.weather2");
