...
public final class Encoder {
  ...
  public static QRCode encode(String content,
    ...
    // Collect data within the activity_wifi_direct segment, separately, to count its size if needed. Don't add it to
    // activity_wifi_direct payload yet.
    ...
    // Find "length" of activity_wifi_direct segment and write it
